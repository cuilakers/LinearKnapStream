...
double sum_cost=0.0;
int K;
string node_cost_text="./rndata/r1_nw_l7/renum_cumulate_normalize_node_cost.txt";
//string node_cost_text="renum_random_node_cost.txt";
string edge_weight_text="./rndata/r1_nw_l7/renum_random_edge_weight.txt";
...
public:
    ...
    //             value += edge_weight[i][j].second;
    //         }
    //         value += edge_weight[i][node].second;
    //         sum_value += sqrt(value);
    //     }
